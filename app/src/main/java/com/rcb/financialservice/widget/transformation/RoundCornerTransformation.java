package com.rcb.financialservice.widget.transformation;
...
public class RoundCornerTransformation implements Transformation {
    ...
    public RoundCornerTransformation(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public RoundCornerTransformation(int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = radius * 2;
        mMargin = margin;
